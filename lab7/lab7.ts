...
const v1: IVehicle = new Vehicle("и3", "Афган", 2010, 242, 21421, owner1);
const v2: IVehicle = new Vehicle("sos", "Арабски", 2025, 2134, 124, owner1);
const v3: IVehicle = new Vehicle("fopfop3", "Форд", 2024, 242, 56845, owner1);
const v4: IVehicle = new Vehicle("soS", "ШКОДА", 2014, 1241, 23523, owner1);
const v5: IVehicle = new Vehicle("SoS", "Ярик", 2019, 3333, 313333, owner);
